...
if __name__ == "__main__":
    ...
    datees = ['2000-01-01', '2000-02-01', '2000-03-01', '2000-04-01', '2000-05-01', '2000-06-01', '2000-07-01', '2000-08-01', '2000-09-01', '2000-10-01', '2000-11-01', '2000-12-01',
    ...
    api_connector = APIConnector('EUR', __currency)
    # api_connector.load_data()
    # api_connector.update_data()
    for date in datees:
        api_connector.get_rate_foreign_exchanges(date)
    api_connector.save_data()
    # for week in range(0, 780):
    #     print((datetime.datetime(2000, 1, 1) + datetime.timedelta(weeks=week)).strftime("%Y-%m-%d"))
    #
    #
    # api_connector.get_rate_foreign_exchanges("2020-01-02")
    # api_connector.get_rate_foreign_exchanges("2020-01-03")
    # api_connector.get_rate_foreign_exchanges("2020-01-04")
    # api_connector.get_rate_foreign_exchanges("2020-01-05")
    #
    # api_connector.save_data()
    #
    ...
    #     outfile.write(json.dumps(data_set, indent=4, sort_keys=True))